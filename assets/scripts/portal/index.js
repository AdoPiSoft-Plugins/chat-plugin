require([
  'knockout',
  'howler',
  '/public/plugins/chat-plugin/scripts/portal/viewModel.js'
], function (ko, howler, VM) {
  ...
  ko.components.register('chat-plugin', {
    viewModel: {
      createViewModel: function (params, componentInfo) {
        ...
        return new VM(params, element);
      }
    },
    template: {require: 'text!/public/plugins/chat-plugin/views/portal/chat.html'}
  })
